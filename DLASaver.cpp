...
HRESULT CDLASaver::InitializeTiling()
{
...
HRESULT CDLASaver::CreateGeometryBuffers()
{
	HRESULT hr = S_OK;
...
HRESULT CDLASaver::PrepareShaderConstants()
{
	HRESULT hr = S_OK;
...
BOOL CDLASaver::PauseSaver()
{
	return TRUE;
}

BOOL CDLASaver::ResumeSaver()
{
	return TRUE;
}

BOOL CDLASaver::IterateSaver(float dt, float T)
{
...
BOOL CDLASaver::UpdateScene(float dt, float T)
{
